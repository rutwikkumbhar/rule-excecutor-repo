...
@Slf4j
@Component
@EnableConfigurationProperties({Nudge3SchedulerProperties.class})
public class Nudge3ScheduleTask {

    private final Nudge3SchedulerProperties schedulerProperties;
    ...
    public Nudge3ScheduleTask(Nudge3SchedulerProperties schedulerProperties,
